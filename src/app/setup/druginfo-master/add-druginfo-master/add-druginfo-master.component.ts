...
export class AddDruginfoMasterComponent implements OnInit {
  ...
  constructor(public commonService: CommonService,private tokenStorage: TokenStorageService,private fb: FormBuilder,private authService: AuthService,public router: Router,
