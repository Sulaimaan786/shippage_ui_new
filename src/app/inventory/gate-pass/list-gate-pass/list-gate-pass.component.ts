...
import { DeleteItemCategoryComponent } from 'src/app/inventory/item-category/list-category/delete-item-category/delete-item-category.component';
...
export class ListGatePassComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  displayedColumns = [
    "gatePassNo",
    "organizationName",
    "location",
