...
import { DeaformService } from "src/app/crm/report/controlled-substance/deaform41/deaform.service";
...
import { DashboardFormService } from "./dashboard-service";
...
export class MainComponent implements OnInit {
  ...
  constructor(private httpService: HttpServiceService,private usersService:UsersService,
    private tokenStorage: TokenStorageService,public dialog: MatDialog, public deaformService:DeaformService,
    private dashboardFormService:DashboardFormService,public router: Router,
    ) {}
  ngOnInit() {
    this.smallChart1();
    this.smallChart2();
  ...
  getCompany(){
    this.httpService.get<any>(this.dashboardFormService.dashboardListUrl).subscribe(
      (data) => {
