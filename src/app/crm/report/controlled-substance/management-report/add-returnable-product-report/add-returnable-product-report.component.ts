...
openPDF() {    
 ...
 generateExcel() {
  ...
  const header = ["NDC/UPC", "Description", "Strength", "Dsg", "Lot#", "Exp Date", "Pkg Size", "Full Qty", "Partial Qty", "Price", "Est Value"]
  ...
  this.searchList.forEach(d => {
    this.dataList = [];
      ...
      this.dataList.push(d.ndcupcCode,d.description,d.strength,d.dosage, d.lotNo,d.expDate,d.pakageSize,d.fullQuantity,d.partialQuantity,d.price,d.estValue);
    // });
...
//  }
  ...
  workbook.xlsx.writeBuffer().then((data) => {
    ...
    fs.saveAs(blob, 'Returnable.xlsx');
  })
