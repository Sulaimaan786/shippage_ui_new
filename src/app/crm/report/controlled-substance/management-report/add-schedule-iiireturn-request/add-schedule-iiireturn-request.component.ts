...
@Component({
  selector: 'app-add-schedule-iiireturn-request',
  templateUrl: './add-schedule-iiireturn-request.component.html',
  styleUrls: ['./add-schedule-iiireturn-request.component.sass']
})
export class AddScheduleIIIReturnRequestComponent implements OnInit {
  [x: string]: any;
  ...
  onTableSizeChange(event: any): void {
    ...
    this.page = 1;
      ...
      printComponent() {
        ...
        let newWin;
        var content = document.getElementById('scheduleIII').innerHTML;
