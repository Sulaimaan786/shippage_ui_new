...
@Component({
  selector: 'app-hazardous-products',
  templateUrl: './hazardous-products.component.html',
  styleUrls: ['./hazardous-products.component.sass'],
  providers: [
...
export class HazardousProductsComponent implements OnInit {
...
this.endDateFlag =true;
          ...
          this.companyName2=data.headerSearchBean[0].searchBeanDetailsList[0].companyName;
...
generateExcel() {
  ...
  const header = ["NDC/UPC", "Description", "Strength", "Dsg", "Returnable", "Pkg Size", "Full Qty", "Partial Qty", "Price", "Total"]
  ...
  this.searchList.forEach(d => {
    this.dataList = [];
      ...
      this.dataList.push(d.ndcupcCode,d.description,d.strength,d.dosage,d.is_returnable,d.pakageSize,d.fullQuantity,d.partialQuantity,d.price);
    // });
